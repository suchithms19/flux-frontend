    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
            <div className={`w-full max-w-md transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <form onSubmit={handleSubmit} className="bg-white text-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
                    ...
                    <div className="mb-6">
                        <label htmlFor="email" className="block text-black mb-2 font-semibold">Email Address</label>
                        <input
                            type="email"
                            id="email"
                            name="email"
                    ...
                    <div className="mb-6">
                        <label className="block text-black mb-2 font-semibold">How did you hear about us?</label>
